	...
	public List<Product> searchList(String ten_san_pham, String ten_the_loai) {
	    ...
	    if (!ten_san_pham.equals("") && !ten_the_loai.equals("")) {
	        sql = "SELECT * FROM product, category " +
	              "WHERE ten_san_pham LIKE N'%" + ten_san_pham + "%' " +
	              "AND product.ma_the_loai = category.ma_the_loai " +
	              "AND ten_the_loai LIKE N'%" + ten_the_loai + "%'";
	    } else {
	        if (ten_san_pham.equals("")) {
	            sql = "SELECT * FROM product, category " +
	                  "WHERE product.ma_the_loai = category.ma_the_loai " +
	                  "AND ten_the_loai LIKE N'%" + ten_the_loai + "%'";
	        } else {
